    ...
    return {
        ...
        initCharts: function () {
            ...
            function showTooltip(title, x, y, contents) {
                $('<div id="tooltip" class="chart-tooltip"><div class="date">' + title + '<div class="label label-important">数值: ' + x * 12 + '<\/div><\/div>').css({
                    position: 'absolute',
                    display: 'none',
                    top: y - 100,
                    width: 75,
                ...
                $("#site_statistics").bind("plothover", function (event, pos, item) {
                    ...
                    if (item) {
                        if (previousPoint != item.dataIndex) {
                            ...
                            showTooltip('2015 04 17', item.pageX, item.pageY);
                        }
                    } else {
                        $("#tooltip").remove();
                        previousPoint = null;
