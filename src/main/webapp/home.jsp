...
<%
    ...
    //<c:out/> tag next:
	request.setAttribute("test", SecurityUtils.getSubject().getPrincipal().toString());
...
%>
<%=username%> <c:out value="${test }"></c:out></shiro:user>!
    ...
    <p>
	    <shiro:hasRole name="administrator">administrator</shiro:hasRole>
	    <shiro:hasRole name="shiro">shiro</shiro:hasRole>
	</p>
    <h3>Roles you don't have</h3>
    <p>
	    <shiro:lacksRole name="administrator">administrator</shiro:lacksRole>
	    <shiro:lacksRole name="shiro">shiro</shiro:lacksRole>
	</p>
	<h3>Permissions</h3>
	<p>
		<shiro:hasPermission name="admin"><a href="www.baidu.com">baidu</a></shiro:hasPermission>
	</p>
