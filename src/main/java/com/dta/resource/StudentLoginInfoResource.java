...
public class StudentLoginInfoResource {
	// @Autowired
	public IStudentLoginInfoService service = (IStudentLoginInfoService) ServiceProvider
			.getBean("studentLoginInfoServiceImpl");
	@Autowired
	public JdbcRealm myRealm;

	/*
	 * public StudentLoginInfoResource(){ super.setService(service);
	...
	public Response login(@FormParam("username") String username,
		...
		try {
			...
			StudentLoginSuccessInfo studentLoginSuccessInfo = service
					.getStudentLoginSuccessInfo(username);
			session.setAttribute("school_id",
					studentLoginSuccessInfo.getSchool_id());
